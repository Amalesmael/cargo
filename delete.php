...
if(isset($_POST["bra_id"]) && !empty($_POST["bra_id"])){
    ...
    $sql = "DELETE FROM branches WHERE bra_id = ?";
            ...
            <div class="col-md-12">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="alert alert-danger">
                        <input type="hidden" name="bra_id" value="<?php echo trim($_GET["bra_id"]); ?>"/>
                        <p>Are you sure you want to delete this branch record?</p>
                        <p>
                            <input type="submit" value="Yes" class="btn btn-danger">
                            <a href="branch.php" class="btn btn-secondary">No</a>
                        </p>
                    </div>
                </form>
            </div>
