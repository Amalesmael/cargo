...
if(isset($_POST["man_id"]) && !empty($_POST["man_id"])){
    ...
    // Validate salary
    $input_salary = trim($_POST["emp_password"]);
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err)){
        ...
        $sql = "UPDATE manager SET man_name=?, man_email=?, man_passowrd=? ,bra_id=? WHERE man_id=?";
    ...
    if(isset($_GET["man_id"]) && !empty(trim($_GET["man_id"]))){
        // Get URL parameter
        $id =  trim($_GET["man_id"]);
        ...
        if($stmt = $connection->prepare($sql)){
            ...
            if($stmt->execute()){
                ...
                if($result->num_rows == 1){
                    ...
                    $name = $row["man_name"];
                    $address = $row["man_email"];
                    $salary = $row["man_passowrd"];
                } else{
            ...
            <div class="col-md-12">
                ...
                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="emp_password" class="form-control <?php echo (!empty($salary_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $salary; ?>">
                    ...
                    <input type="hidden" name="man_id" value="<?php echo $id; ?>"/>
                    <input type="submit" class="btn btn-primary" value="Update">
                    <a href="manger.php" class="btn btn-secondary ml-2">Cancel</a>
                </form>
            </div>
        </div>
    </div>
