...
if (isset($_POST['send'])) {
    ...
    $notes = $_POST['subject'];
    $man_id  = $_SESSION != null ?  $_SESSION['man_id'] != null ? $_POST['man_id'] : null : null;
    ...
    if ($man_id != null) {
        $insertsqlshipment = "INSERT INTO `shipment`(`shi_weight`,`shi_date`,`shi_type`,`shi_consignee_address`,`shi_consignee_name`,`shi_sender_name`,`shi_sender_address`,`shi_Notes`,`man_id`,`bra_id`,`com_id`) VALUES ('$shi_weight', '$the_date' ,'$Charging_Type','$address_client','$names_client','$name_sender','$address_sender','$notes','$man_id','$bra_id','$com_id')";
    }else{
...
<div class="landing">
    ...
    <div class="contener">
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="./orderad.php" class="activ">Orders shipments</a></li>
    ...
    <div class="contact">
        <div class="container">
            <!-- <h2>Contact Us</h2> -->
            <form action="orderad.php"  method="post">
                ...
                <div data-aos="fade-left"  class="right">
                    ...
                    if($_SESSION != null) {
                        ...
                        if ($_SESSION['man_id'] != null) {
                            echo '<input type="hidden" name="man_id" value="' . $_SESSION['man_id'] . '">' ;
