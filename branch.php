        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Branches Details</h2>
                    <a href="create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Branche </a>
                </div>
                <?php
                // Include config file
                require_once "db.php";
                ...
                if($result = $connection->query($sql)){
                    if($result->num_rows > 0){
                        ...
                        while($row = $result->fetch_array()){
                            ...
                            echo "<td>" . $row['bra_address'] . "</td>";
                            echo "<td>" . $row['bra_phone'] . "</td>";
                            echo "<td>";
                            echo '<a href="update.php?bra_id='. $row['bra_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil text-secondary"></span></a>';
                            echo '<a href="delete.php?bra_id='. $row['bra_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash text-danger"></span></a>';
                            echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
