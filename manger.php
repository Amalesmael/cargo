        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mt-5 mb-3 clearfix">
                    <h2 class="pull-left">Manger Details</h2>
                    <a href="manger_create.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add New manager</a>
                </div>
                <?php
                // Include config file
                require_once "db.php";
                ...
                if($result = mysqli_query($connection, $sql)){
                    if(mysqli_num_rows($result) > 0){
                        ...
                        while($row = mysqli_fetch_array($result)){
                            ...
                            echo "<td>";
                            echo '<a href="man_update.php?man_id='. $row['man_id'] .'" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil text-secondary"></span></a>';
                            echo '<a href="man_delete.php?man_id='. $row['man_id'] .'" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash text-danger"></span></a>';
                            echo "</td>";
                            echo "</tr>";
                        }
                        echo "</tbody>";
